...
extern const char* const VolumeStr[FF_VOLUMES];	/* Pre-defined volume ID */
#endif
#endif
...
#endif
extern const BYTE GUID_MS_Basic[16];
#endif
...
#elif FF_CODE_PAGE < 900	/* extern code page configuration (SBCS) */
